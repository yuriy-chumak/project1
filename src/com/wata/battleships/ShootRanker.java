...
public interface ShootRanker {
	 ...
	 */
	int getRank(Shoot move, AbstractBattleField board, int depth);
	 ...
	 */
	void onNodeEvaluation(Shoot move, AbstractBattleField board, int score, Player player, int depth);
